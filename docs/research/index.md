...
- paprika storage study
- paprika kinetic modeling
...
### [Carotenoid Chemistry](../glossary/spice-science/carotenoids.md)
...
### [ASTA Degradation Kinetics](../quality-control/storage.md)
...
### [Antioxidant Activity](../quality-control/antioxidant.md)
...
### [Shelf Life Modeling](../regulatory/shelf-life.md)
...
### [Color Science & CIELAB](../quality-control/color-science.md)
...
|:------|:------|:-----:|:---------:|
| [Paprika Origin Guide](../white-papers/paprika-origin-guide.md) | Global origin comparison (Xinjiang, Hungary, Spain, Serbia, India) | ~45 | 45 min |
| [ASTA Color Value Guide](../white-papers/asta-color-value-guide.md) | Complete methodology and interpretation | ~35 | 35 min |
| [Paprika Grades Explained](../white-papers/paprika-grades-explained.md) | Premium vs Superior vs Standard vs Special | ~30 | 30 min |
| [Paprika Specifications Guide](../white-papers/paprika-specifications.md) | Every spec parameter explained | ~30 | 30 min |
| [Paprika Supply Chain Guide](../white-papers/paprika-supply-chain.md) | Farm-to-port flow with CCP mapping | ~25 | 25 min |

## References and Further Reading

Key scientific references used in this research library:

1. Minguez-Mosquera, M.I. et al. (1993) — "Carotenoid content of Capsicum annuum varieties" — *Journal of Agricultural and Food Chemistry*
2. Biacs, P.A. et al. (1992) — "Carotenoid stability in paprika" — *Acta Alimentaria*
3. Pérez-Gálvez, A. et al. (2004) — "Correlation of ASTA color values with CIELAB coordinates" — *European Food Research and Technology*
4. Hornero-Méndez, D. & Mínguez-Mosquera, M.I. (2001) — "Rapid spectrophotometric determination of red and yellow isochromic carotenoid fractions" — *Journal of Agricultural and Food Chemistry*
