...
|:---------:|:-----:|:------:|
| Aerobic Plate Count | [value] CFU/g | ISO 4833 |
...
| Metal | Limit (mg/kg) | Method |
|:-----:|:-------------:|:------:|
| Lead (Pb) | [value] | ICP-MS |
| Cadmium (Cd) | [value] | ICP-MS |
...
- [Application 1 — e.g., Processed meats: sausages, surimi, meat analogs]
- [Application 2 — e.g., Seasoning blends: rubs, marinades, snack seasonings]
- [Application 3 — e.g., Food coloring: sauces, soups, ready meals]
- [Application 4 — e.g., Oleoresin extraction: natural food colorant E160c]

## Certifications

- [Certification 1 — e.g., HACCP (Codex Alimentarius)]
- [Certification 2 — e.g., ISO 22000:2018]
- [Certification 3 — e.g., Kosher (annual renewal)]
- [Certification 4 — e.g., USDA Organic / EU Organic (as applicable)]

## Regulatory Compliance

| Market | Key Requirement |
|:-------|:----------------|
| **European Union** | EC 396/2005 (MRLs), EC 1881/2006 (contaminants), ESA Quality Minima |
| **United States** | FSMA FSVP, 21 CFR Part 117 (HACCP) |
| **China** | GB 2762 (contaminants), GB 2763 (MRLs) |
| **Japan** | Food Sanitation Act, Positive List System |
